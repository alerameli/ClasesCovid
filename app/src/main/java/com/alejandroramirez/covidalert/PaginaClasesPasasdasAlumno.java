...
public class PaginaClasesPasasdasAlumno extends AppCompatActivity implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_clases_pasasdas_alumno);

        rv = findViewById(R.id.rv_PCPA);
        rq = Volley.newRequestQueue(getApplicationContext());
        listaClases = new ArrayList<Clase>();

        // Se obtiene los datos de "Usuario" de la clase anterior "MainActivity.java"
        usuario = (Usuario) getIntent().getSerializableExtra("usuario");

        // Se crea una URL para mostrar las diferentes clases para el "Usuario"
        URL = "https://a217200082.000webhostapp.com/mostrarClasesPasadasA.php?AIDI=" + usuario.getId();
